...
open class MarketingMaterialsAPI {
    ...
    /**
     ...
     - parameter uuid: (path) UUID of the marketing material template record. 
     - parameter marketingMaterialTemplatePublishPayload: (body)  (optional)
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func putMarketingMaterialsTemplatesUuidPublish(uuid: UUID, marketingMaterialTemplatePublishPayload: MarketingMaterialTemplatePublishPayload? = nil, apiResponseQueue: DispatchQueue = Aryeo.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) {
        putMarketingMaterialsTemplatesUuidPublishWithRequestBuilder(uuid: uuid, marketingMaterialTemplatePublishPayload: marketingMaterialTemplatePublishPayload).execute(apiResponseQueue) { result -> Void in
            switch result {
            case .success:
                completion((), nil)
    ...
    /**
     Publish a marketing material template.
     - PUT /marketing-materials/templates/{uuid}/publish
     - Publish a marketing material template.
     - BASIC:
       - type: http
       - name: JWT
     ...
     */
    open class func putMarketingMaterialsTemplatesUuidPublishWithRequestBuilder(uuid: UUID, marketingMaterialTemplatePublishPayload: MarketingMaterialTemplatePublishPayload? = nil) -> RequestBuilder<Void> {
        var path = "/marketing-materials/templates/{uuid}/publish"
        ...
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: marketingMaterialTemplatePublishPayload)
