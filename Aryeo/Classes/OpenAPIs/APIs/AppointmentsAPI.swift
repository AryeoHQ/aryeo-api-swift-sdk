...
open class AppointmentsAPI {
     ...
     */
    open class func getAppointments(include: String? = nil, filterTense: FilterTense_getAppointments? = nil, filterStartAtGte: Date? = nil, filterStartAtLte: Date? = nil, filterUserIds: Array? = nil, sort: String? = nil, perPage: String? = nil, page: String? = nil, apiResponseQueue: DispatchQueue = Aryeo.apiResponseQueue, completion: @escaping ((_ data: AppointmentCollection?, _ error: Error?) -> Void)) {
     ...
     */
    open class func getAppointmentsWithRequestBuilder(include: String? = nil, filterTense: FilterTense_getAppointments? = nil, filterStartAtGte: Date? = nil, filterStartAtLte: Date? = nil, filterUserIds: Array? = nil, sort: String? = nil, perPage: String? = nil, page: String? = nil) -> RequestBuilder<AppointmentCollection> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getUnconfirmedAppointments(include: String? = nil, filterUserIds: Array? = nil, sort: String? = nil, perPage: String? = nil, page: String? = nil, apiResponseQueue: DispatchQueue = Aryeo.apiResponseQueue, completion: @escaping ((_ data: UnconfirmedAppointmentCollection?, _ error: Error?) -> Void)) {
     ...
     */
    open class func getUnconfirmedAppointmentsWithRequestBuilder(include: String? = nil, filterUserIds: Array? = nil, sort: String? = nil, perPage: String? = nil, page: String? = nil) -> RequestBuilder<UnconfirmedAppointmentCollection> {
